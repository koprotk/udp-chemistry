...
\begin{frame}{Reactivo limitante y en exceso}
  \begin{enumerate}
    \item Dada la reacción \ce{Cu + 2AgNO3 -> 2Ag + Cu(NO3)2} ¿Cuántos gramos de Ag se producirán a partir de \qty{5,00}{g} de Cu y \qty{1,00}{g} de \ce{AgNO3}?
    \item La urea \ce{(NH2)2CO} se usa como fertilizante, como alimento para animales y en la industria de los polímeros. Se prepara una reacción del amoniaco con el dióxido de carbono: \ce{NH3(g) + CO2(g) -> (NH2)2CO(ac) + H2O(l)} En cierto proceso, se hacen reaccionar \qty{637,3}{g} de amoniaco con \qty{1,141}{kg} de dióxido de carbono.
          \begin{enumerate}
            \item ¿Cuál de los reactivos es el limitante?
            \item Calcular la masa de urea formada.
            \item ¿Qué cantidad de reactivo excedente en gramos queda al finalizar la reacción?
          \end{enumerate}
  \end{enumerate}
\end{frame}
