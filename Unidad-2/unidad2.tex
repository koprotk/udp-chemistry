...
\begin{frame}{Reactivo limitante y en exceso}
  \begin{enumerate}
    ...
    \item La urea \ce{(NH2)2CO} se usa como fertilizante, como alimento para animales y en la industria de los polímeros. Se prepara una reacción del amoniaco con el dióxido de carbono: \ce{NH3(g) + CO2(g) -> (NH2)CO(ac) + H2O(l)} En cierto proceso, se hacen reaccionar \qty{637,3}{g} de amoniaco con \qty{1,141}{kg} de dióxido de carbono.
          \begin{enumerate}
