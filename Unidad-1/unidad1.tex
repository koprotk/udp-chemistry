...
\begin{frame}[label={sec:org41c6996}]{Evaluaciones Sumativas (con nota)}
  \begin{columns}
    \begin{column}{0.5\columnwidth}
      \begin{itemize}
        \item Revisar programa en Canvas. 
      \end{itemize}
    \end{column}
    \begin{column}{0.5\columnwidth}
      \begin{figure}[htbp]
    ...
    \begin{column}{0.5\columnwidth}
      ...
      \only<3>{
        \begin{figure}[htbp]
          ...
          \caption{Modelo atómico de ``pan de pascuas''}
        \end{figure}
      }
    \end{column}
  \end{columns}
    ...
    \begin{column}{0.5\columnwidth}
      ...
      \only<3>{
        \begin{figure}[htbp]
          ...
          \caption{Modelo atómico planetario}
        \end{figure}
      }
    \end{column}
  \end{columns}
...
\begin{frame}[label={sec:orgf9efcc4}]{Entonces, ¿Como describimos un átomo?}
  \begin{columns}
    ...
    \begin{column}{0.5\columnwidth}
      \huge
      \centering
      \ce{^{\alert<3>{227}}_{\alert<2>{90}}{\alert<4>{Th}}^{\alert<5>{+}}}
      \vspace{1cm}
      ...
      \begin{itemize}[<+->]
        ...
        \item Fuerzas de Van der Waals
              \begin{itemize}
                \item diper-diper
                      \begin{itemize}
                        \item Puentes de Hidrógeno (N, O, F) 
                      \end{itemize}
                \item diper-dipin
